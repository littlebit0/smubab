...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        console.log(`Crawling today's menus for ${todayStr}`);
        ...
        // 오늘 날짜만 필터링
        const todayMenus = allMenus.filter(menu => menu.date === todayStr);

        console.log(`Total ${todayMenus.length} menus for today`);
